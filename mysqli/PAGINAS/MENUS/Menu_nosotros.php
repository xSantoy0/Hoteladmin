        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../PAGINAS/Nosotros.php">
                    ...
                    <a class="nav-link active" aria-current="page" href="../PAGINAS/Registro.php">
                ...
                <section class="main">
                    <a class="nav-link active" aria-current="page" style="margin-left: 20px" href="../PAGINAS/Ingreso.php">
